...
val presentationModule = module {
    ...
    factory { ReservasModel(get(), get(), get(), get(),get(),get(),get()) }

    factory { (reservaId: String) -> AceptarRetoModel(reservaId, get(), get(), get()) }
    ...
    factory { (isLogged: Boolean,usuarioId: Int?) ->
        RegisterDatosModel(isLogged, usuarioId,get(), get(), get(), get(), get(),get())
    }
