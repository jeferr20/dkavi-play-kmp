...
class RegisterDatosModel(
        ...
        screenModelScope.launch {
            ...
            try {
                ...
                if (isLogged) {
                    ...
                    val sedesResult = s.idDepartamento?.let { getSedesByUbigeoUseCase(it) }
    ...
    private fun loadSedes(idDepartamento: String) {
        screenModelScope.launch {
            val result = getSedesByUbigeoUseCase(idDepartamento)
            updateState {
    ...
    fun onRegisterPersona() {
        ...
        screenModelScope.launch {
            ...
            registerPersonaUseCase(s.toRequestDto())
                .onSuccess {
                    updateState {
                        copy(
                            isLoading = false,
